        ...
        <div className="md:w-[70%] mt-[60px]  ">
          <div className="text-center">
            <h1 className="text-[#6e9240] text-4xl  font-[500]">
              Get Access to Real TEAS Exam Questions!
            </h1>

            <h2 className="mt-4 font-bold ">
              These are the Latest, Most Accurate Questions We've Gathered for
              You – Say Goodbye to Stress and Prepare with Confidence!
            </h2>
          </div>
