...
const Online = () => {
  return (
    <>
      <div className="w-[100%] bg-[#FFFFFF] flex justify-center items-center">
        <div className="w-[80%]">
          ...
          <div className="flex flex-col  md:flex-row md:justify-between gap-10 mt-4 ">
            <div className="md:w-[50%]">
              ...
              <h1 className=" text-black mt-6  text-justify   ">
                ...
                everything you need to succeed.  Includes a comprehensive set
                of TEAS 7 exact exam questions with correct answers.  Covers
                all key subjects: Reading, Math, Science, English and Language
                Usage.  Focuses on the exact questions you need to improve your
                score to a 90.
              </h1>
              <p className="mt-8 text-justify  ">
