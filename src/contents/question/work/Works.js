    ...
    <>
        ...
        <div className="w-[90%] bg-[#FFF4CE] py-20  ">
          ...
          <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  gap-5 mt-10 px-10  ">
            <div>
              <img src="/question/fill.webp" className="h-[250px] w-[100%]" />
              <h1 className="font-bold text-black  text-2xl text-center mt-4 ">
              Make Payment
              </h1>
              <h1 className="text-black mt-4  text-center ">
              To gain access to the exact TEAS questions we've collected so far, a payment of $149.99 is required. This will give you access to five updates of the TEAS Version 7 exam.
              </h1>
            </div>
            <div>
              <img src="/question/fill.webp" className="h-[250px] w-[100%]" />
